         ...
         >
           <div className="relative mb-6">
             <motion.div 
               ...
               className="w-28 h-28 bg-white rounded-[2.5rem] shadow-2xl shadow-primary/20 flex items-center justify-center border-4 border-white overflow-hidden relative"
             >
             ...
             <motion.div 
               ...
               className="absolute -bottom-2 -right-2 w-10 h-10 bg-secondary rounded-2xl flex items-center justify-center border-4 border-white shadow-lg text-white"
             >
